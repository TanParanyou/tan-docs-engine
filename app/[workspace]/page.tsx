      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-2">
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0">
            <Link
              href="/"
              className="inline-flex items-center gap-1 text-xs font-medium text-slate-500 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 px-2 sm:px-2.5 py-1.5 rounded-lg transition-colors flex-shrink-0"
              title="กลับหน้าหลัก"
            >
            ...
            <div className="min-w-0 truncate">
              <span className="font-bold text-slate-900 text-xs sm:text-sm truncate inline-block max-w-[120px] sm:max-w-[200px] md:max-w-none align-middle">
                {config.name}
              </span>
              <span className="mx-1.5 text-slate-300">/</span>
              <span className="text-[11px] sm:text-xs text-slate-500 font-mono">v{config.version}</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-3 flex-shrink-0">
            <Link
              href={`/${slug}/edit`}
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 px-2.5 sm:px-3 py-1.5 rounded-lg shadow-sm transition-colors"
            ...
            <Link
              href={`/${slug}/print`}
              target="_blank"
              className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-white border border-slate-200 hover:border-slate-300 px-2 sm:px-3 py-1.5 rounded-lg shadow-sm transition-colors"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 px-2.5 sm:px-3.5 py-1.5 rounded-lg shadow-sm shadow-blue-500/20 transition-colors"
              title="ดาวน์โหลด PDF"
            >
